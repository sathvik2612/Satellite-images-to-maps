...
def define_discriminator(image_shape):
	...
	# source image input
	in_src_image = tf.keras.Input(shape=image_shape)  #Image we want to convert to another image
	# target image input
	in_target_image = tf.keras.Input(shape=image_shape)  #Image we want to generate after training. 
